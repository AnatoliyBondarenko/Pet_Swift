...
//
        memberStackView = UIStackView(arrangedSubviews: [teamMemberOneLabel,teamMemberTwoLabel,teamMemberThreeLabel, teamMemberFourLabel,teamMemberFiveLabel,teamMemberSixLabel
        ])
